...
public class RegistrarController {
    ...
    private void addUser() throws IOException, SQLException {
        udao.addUsuario(new Usuario(Integer.parseInt(codigo_usuarios.getText()),nombre.getText(),apellido.getText(),email.getText(),pwd.getText(),DNI.getText(),domicilio.getText(),ciudad.getText(),provincia.getText()));
    }
